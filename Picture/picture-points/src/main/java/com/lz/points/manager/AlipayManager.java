...
public class AlipayManager {
    ...
    public AlipayConfig getAlipayConfig() {
        ...
        String privateKey = FileUtils.readFileContent(config.getPrivateKeyPath());
        alipayConfig.setPrivateKey(privateKey);
        String alipayPublicKey = FileUtils.readFileContent(config.getPublicKeyPath());
    ...
    public AlipayPcPaymentResponse pcPay(AlipayPcPaymentRequest alipayPcPaymentRequest) throws AlipayApiException {
        // 初始化SDK
