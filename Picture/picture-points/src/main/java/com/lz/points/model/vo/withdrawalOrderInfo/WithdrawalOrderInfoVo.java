package com.lz.points.model.vo.withdrawalOrderInfo;
 ...
 */
@Data
public class WithdrawalOrderInfoVo implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param withdrawalOrderInfo WithdrawalOrderInfo实体对象
     * @return WithdrawalOrderInfoVo
     */
    public static WithdrawalOrderInfoVo objToVo(WithdrawalOrderInfo withdrawalOrderInfo) {
        if (withdrawalOrderInfo == null) {
            return null;
        }
        WithdrawalOrderInfoVo withdrawalOrderInfoVo = new WithdrawalOrderInfoVo();
        BeanUtils.copyProperties(withdrawalOrderInfo, withdrawalOrderInfoVo);
        return withdrawalOrderInfoVo;
    }
}
