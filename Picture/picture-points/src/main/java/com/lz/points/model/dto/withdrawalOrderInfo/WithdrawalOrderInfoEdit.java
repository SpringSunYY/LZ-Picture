 ...
 */
@Data
public class WithdrawalOrderInfoEdit implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param withdrawalOrderInfoEdit 编辑对象
     * @return WithdrawalOrderInfo
     */
    public static WithdrawalOrderInfo editToObj(WithdrawalOrderInfoEdit withdrawalOrderInfoEdit) {
        if (withdrawalOrderInfoEdit == null) {
            return null;
        }
        WithdrawalOrderInfo withdrawalOrderInfo = new WithdrawalOrderInfo();
        BeanUtils.copyProperties(withdrawalOrderInfoEdit, withdrawalOrderInfo);
        return withdrawalOrderInfo;
    }
}
