 ...
 */
@Data
public class PictureDownloadLogEdit implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param pictureDownloadLogEdit 编辑对象
     * @return PictureDownloadLog
     */
    public static PictureDownloadLog editToObj(PictureDownloadLogEdit pictureDownloadLogEdit) {
        if (pictureDownloadLogEdit == null) {
            return null;
        }
        PictureDownloadLog pictureDownloadLog = new PictureDownloadLog();
        BeanUtils.copyProperties(pictureDownloadLogEdit, pictureDownloadLog);
        return pictureDownloadLog;
    }
}
