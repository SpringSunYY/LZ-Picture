...
public class PictureRecommendInfoVo implements Serializable {
     ...
     * @return PictureRecommendInfoVo
     */
    public static PictureRecommendInfoVo objToVo(PictureRecommendInfo pictureRecommendInfo) {
        if (pictureRecommendInfo == null) {
            return null;
        }
        PictureRecommendInfoVo pictureRecommendInfoVo = new PictureRecommendInfoVo();
        BeanUtils.copyProperties(pictureRecommendInfo, pictureRecommendInfoVo);
        return pictureRecommendInfoVo;
    }
}
