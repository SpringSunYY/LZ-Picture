...
@Data
@AllArgsConstructor
public class SpaceDilatationInfoCalculationVo implements Serializable {
    @Serial
     ...
     */
    public static SpaceDilatationInfo insertToObj(SpaceDilatationInfoCalculationVo spaceDilatationInfoInsert) {
