 ...
 */
@Data
public class SpaceDilatationInfoInsert implements Serializable
{
     ...
     */
    public static SpaceDilatationInfo insertToObj(SpaceDilatationInfoInsert spaceDilatationInfoInsert) {
