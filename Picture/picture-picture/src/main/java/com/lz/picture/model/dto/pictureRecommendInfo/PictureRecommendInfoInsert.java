 ...
 */
@Data
public class PictureRecommendInfoInsert implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param pictureRecommendInfoInsert 插入对象
     * @return PictureRecommendInfoInsert
     */
    public static PictureRecommendInfo insertToObj(PictureRecommendInfoInsert pictureRecommendInfoInsert) {
        if (pictureRecommendInfoInsert == null) {
            return null;
        }
        PictureRecommendInfo pictureRecommendInfo = new PictureRecommendInfo();
        BeanUtils.copyProperties(pictureRecommendInfoInsert, pictureRecommendInfo);
