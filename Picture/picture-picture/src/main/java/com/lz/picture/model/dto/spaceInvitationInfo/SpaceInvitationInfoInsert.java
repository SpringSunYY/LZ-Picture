 ...
 */
@Data
public class SpaceInvitationInfoInsert implements Serializable
{
     ...
     */
    public static SpaceInvitationInfo insertToObj(SpaceInvitationInfoInsert spaceInvitationInfoInsert) {
