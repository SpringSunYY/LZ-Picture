<template>
  <div class="vertical-fall-Layout">
    <div class="masonry">
      ...
      >
        <MasonryImage :src="item.pictureUrl" :alt="item.name">
          <div class="masonry-item-content">
            ...
            <div class="masonry-item-meta">
              <div class="meta-item">
                <SvgIcon name="aiView" />
                <span class="meta-content">{{ item.lookCount }}</span>
              </div>
              <div class="meta-item">
                <SvgIcon name="like" />
                <span class="meta-content">{{ item.likeCount }}</span>
              </div>
              <div class="meta-item">
                <SvgIcon name="share" />
                <span class="meta-content">{{ item.shareCount }}</span>
              </div>
              <div class="meta-item">
                <SvgIcon name="collect" />
                <span class="meta-content">{{ item.collectCount }}</span>
              </div>
            </div>
          </div>
        </MasonryImage>
...
import type { PictureInfoAiVo, PictureInfoVo } from '@/types/picture/picture'
...
//所有的图片数据
const pictrures = ref<(PictureInfoAiVo & { rowSpan: number })[]>([])
