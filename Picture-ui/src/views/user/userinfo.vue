      ...
      <div class="avatar-section">
        <div class="avatar-wrapper">
          <a-avatar
            ...
            :src="initCover(userInfo?.avatarUrl)"
          />
...
import UserBehaviorTable from '@/components/table/UserBehaviorTable.vue'
import DictTag from '@/components/DictTag.vue'
import PointsRechargeTable from '@/components/table/PointsRechargeTable.vue'
import { checkLogin, checkPermiSingle } from '@/utils/permission.ts'
import UserViewInfoTable from '@/components/table/UserViewInfoTable.vue'
import UserPointsUsageLog from '@/components/table/UserPointsUsageLog.vue'
import PictureDownloadLogInfoTable from '@/components/picture/PictureDownloadLogInfoTable.vue'
import type { AccountInfoVo } from '@/types/points/account'
import UserloginLogTable from '@/components/table/UserloginLogTable.vue'
