    ...
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="统计类型" prop="type">
        <el-select v-model="queryParams.type" style="width: 200px" placeholder="请选择统计类型" clearable>
          <el-option
              v-for="dict in po_statistics_type"
              :key="dict.value"
              :label="dict.label"
              :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
            ...
            icon="Plus"
            @click="handleAdd"
            v-hasPermi="['points:statisticsInfo:add']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="single"
            @click="handleUpdate"
            v-hasPermi="['points:statisticsInfo:edit']"
        >修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['points:statisticsInfo:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            icon="Download"
            @click="handleExport"
            v-hasPermi="['points:statisticsInfo:export']"
        >导出
        </el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['points:statisticsInfo:edit']">修改
          </el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['points:statisticsInfo:remove']">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
} from "@/api/points/statisticsInfo";

const {proxy} = getCurrentInstance();
const {po_statistics_type} = proxy.useDict('po_statistics_type');
...
function handleExport() {
  proxy.download('points/statisticsInfo/export', {
    ...queryParams.value
