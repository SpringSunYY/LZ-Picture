<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
                  ...
                  <el-form-item label="套餐生效时间" prop="startTime">
    ...
    <el-table v-loading="loading" :data="pointsRechargePackageInfoList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              <el-table-column label="套餐编号" align="center" prop="packageId" v-if="columns[0].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="套餐名称" align="center" prop="packageName" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="套餐价格" align="center" prop="price" v-if="columns[2].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="套餐积分数量" align="center" prop="points" v-if="columns[3].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="套餐赠送积分" align="center" prop="pointsBonus" v-if="columns[4].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="套餐描述" align="center" prop="description" v-if="columns[5].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="套餐生效时间" align="center" prop="startTime" width="180" v-if="columns[7].visible" :show-overflow-tooltip="true">
                <template #default="scope">
                  <span>{{ parseTime(scope.row.startTime, '{y}-{m}-{d} {h}:{i}:{s}') }}</span>
                </template>
              </el-table-column>
                <el-table-column label="套餐结束时间" align="center" prop="endTime" width="180" v-if="columns[8].visible" :show-overflow-tooltip="true">
                <template #default="scope">
                ...
                <el-table-column label="更新时间" align="center" prop="updateTime" width="180" v-if="columns[11].visible" :show-overflow-tooltip="true">
                <template #default="scope">
        ...
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['points:pointsRechargePackageInfo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['points:pointsRechargePackageInfo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="pointsRechargePackageInfoRef" :model="form" :rules="rules" label-width="80px">
                        <el-form-item label="套餐名称" prop="packageName">
                        ...
                        <el-form-item label="套餐积分数量" prop="points">
                          <el-input v-model="form.points" placeholder="请输入套餐积分数量" />
                        </el-form-item>
                        <el-form-item label="套餐赠送积分" prop="pointsBonus">
                          <el-input v-model="form.pointsBonus" placeholder="请输入套餐赠送积分" />
                        </el-form-item>
...
<script setup name="PointsRechargePackageInfo">
  import { listPointsRechargePackageInfo, getPointsRechargePackageInfo, delPointsRechargePackageInfo, addPointsRechargePackageInfo, updatePointsRechargePackageInfo } from "@/api/points/pointsRechargePackageInfo";
