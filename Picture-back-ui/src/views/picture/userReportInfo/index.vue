<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userReportInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="审核信息" align="center" prop="reviewMessage" v-if="columns[11].visible"
                       :show-overflow-tooltip="true"/>
...
const data = reactive({
  ...
  columns: [
    ...
    {key: 9, label: '举报时间', visible: true},
    {key: 10, label: '审核状态', visible: true},
    {key: 11, label: '审核信息', visible: false},
    {key: 12, label: '审核人编号', visible: false},
