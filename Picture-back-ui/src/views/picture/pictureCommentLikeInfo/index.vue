<template>
  <div class="app-container">
    ...
    <el-table ref="tableRef" v-loading="loading" :data="pictureCommentLikeInfoList" @selection-change="handleSelectionChange"
              @sort-change="customSort">
      <el-table-column type="selection" width="55" align="center"/>
      <el-table-column label="点赞编号" align="center" prop="likeId" v-if="columns[0].visible"
      ...
      <el-table-column label="点赞时间" align="center" prop="createTime" width="180" v-if="columns[4].visible"
                       :show-overflow-tooltip="true">
        <template #default="scope">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['picture:pictureCommentLikeInfo:edit']">修改
          </el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['picture:pictureCommentLikeInfo:remove']">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
import {
  listPictureCommentLikeInfo,
  getPictureCommentLikeInfo,
  delPictureCommentLikeInfo,
  addPictureCommentLikeInfo,
  updatePictureCommentLikeInfo
} from "@/api/picture/pictureCommentLikeInfo";
