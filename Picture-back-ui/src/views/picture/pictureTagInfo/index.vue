  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="pictureTagInfoList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              <el-table-column label="标签编号" align="center" prop="tagId" v-if="columns[0].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="标签名称" align="center" prop="name" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="标签描述" align="center" prop="tagDesc" v-if="columns[2].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="使用次数" align="center" prop="usageCount" v-if="columns[3].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="查看次数" align="center" prop="lookCount" v-if="columns[4].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="下载次数" align="center" prop="downloadCount" v-if="columns[5].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="所属用户" align="center" prop="userId" v-if="columns[6].visible" :show-overflow-tooltip="true"/>
        ...
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['picture:pictureTagInfo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['picture:pictureTagInfo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script setup name="PictureTagInfo">
  import { listPictureTagInfo, getPictureTagInfo, delPictureTagInfo, addPictureTagInfo, updatePictureTagInfo } from "@/api/picture/pictureTagInfo";
  ...
  const data = reactive({
    ...
    columns: [
              { key: 0, label: '标签编号', visible: true },
                ...
                { key: 2, label: '标签描述', visible: true },
                { key: 3, label: '使用次数', visible: true },
