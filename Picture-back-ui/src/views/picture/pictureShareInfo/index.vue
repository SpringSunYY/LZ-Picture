<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="pictureShareInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="转发编号" align="center" prop="shareId" v-if="columns[0].visible"
      ...
      <el-table-column label="转发时间" align="center" prop="createTime" width="180" v-if="columns[6].visible"
                       :show-overflow-tooltip="true">
        <template #default="scope">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['picture:pictureShareInfo:edit']">修改
          </el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['picture:pictureShareInfo:remove']">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
import {
  listPictureShareInfo,
  getPictureShareInfo,
  delPictureShareInfo,
  addPictureShareInfo,
  updatePictureShareInfo
} from "@/api/picture/pictureShareInfo";
