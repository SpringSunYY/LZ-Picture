<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userViewLogInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="设备唯一标识" align="center" prop="deviceId" v-if="columns[11].visible"
                       :show-overflow-tooltip="true"/>
      <el-table-column label="浏览器类型" align="center" prop="browser" v-if="columns[12].visible"
                       :show-overflow-tooltip="true"/>
      <el-table-column label="操作系统" align="center" prop="os" v-if="columns[13].visible"
                       :show-overflow-tooltip="true"/>
