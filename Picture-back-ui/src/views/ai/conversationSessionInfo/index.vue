<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="conversationSessionInfoList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              <el-table-column label="会话编号" align="center" prop="sessionId" v-if="columns[0].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="用户编号" align="center" prop="userId" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="AI会话编号" align="center" prop="conversationId" v-if="columns[2].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="对话名称" align="center" prop="sessionName" v-if="columns[3].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="累计消耗Tokens" align="center" prop="tokensTotalUsed" v-if="columns[4].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="累计消耗积分" align="center" prop="pointsTotalUsed" v-if="columns[5].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="备注" align="center" prop="remark" v-if="columns[6].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="用户IP地址" align="center" prop="ipAddr" v-if="columns[7].visible" :show-overflow-tooltip="true"/>
        ...
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['ai:conversationSessionInfo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['ai:conversationSessionInfo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script setup name="ConversationSessionInfo">
  import { listConversationSessionInfo, getConversationSessionInfo, delConversationSessionInfo, addConversationSessionInfo, updateConversationSessionInfo } from "@/api/ai/conversationSessionInfo";
