  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="conversationLogInfoList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              <el-table-column label="对话记录编号" align="center" prop="conversationId" v-if="columns[0].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="会话编号" align="center" prop="sessionId" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="用户编号" align="center" prop="userId" v-if="columns[2].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="用户输入文本" align="center" prop="inputText" v-if="columns[3].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="AI返回文本" align="center" prop="outputText" v-if="columns[4].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="响应时间" align="center" prop="responseTime" width="180" v-if="columns[6].visible" :show-overflow-tooltip="true">
                <template #default="scope">
                ...
                <el-table-column label="模型返回码" align="center" prop="aiStatusCode" v-if="columns[10].visible" :show-overflow-tooltip="true"/>
        ...
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['ai:conversationLogInfo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['ai:conversationLogInfo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script setup name="ConversationLogInfo">
  import { listConversationLogInfo, getConversationLogInfo, delConversationLogInfo, addConversationLogInfo, updateConversationLogInfo } from "@/api/ai/conversationLogInfo";
