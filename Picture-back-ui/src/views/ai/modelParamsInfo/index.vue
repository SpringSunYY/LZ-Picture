  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="modelParamsInfoList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              <el-table-column label="模型编号" align="center" prop="modelId" v-if="columns[0].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="模型KEY" align="center" prop="modelKey" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="模型名称" align="center" prop="modelName" v-if="columns[2].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="模型" align="center" prop="model" v-if="columns[4].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="名称" align="center" prop="modelLabel" v-if="columns[5].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="安全密钥" align="center" prop="apiKey" v-if="columns[6].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="安全KEY" align="center" prop="secretKey" v-if="columns[7].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="价格" align="center" prop="priceUse" v-if="columns[8].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="模型参数" align="center" prop="modelParams" v-if="columns[9].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="模型介绍" align="center" prop="modelDescription" v-if="columns[10].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="使用次数" align="center" prop="usageCount" v-if="columns[11].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="积分" align="center" prop="ponintsNeed" v-if="columns[12].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="扩展配置" align="center" prop="extendConfig" v-if="columns[13].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="状态" align="center" prop="paramsStatus" v-if="columns[14].visible">
                <template #default="scope">
                      <dict-tag :options="ai_model_params_status" :value="scope.row.paramsStatus"/>
                </template>
              </el-table-column>
                <el-table-column label="排序" align="center" prop="orderNum" v-if="columns[15].visible" :show-overflow-tooltip="true"/>
        ...
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['ai:modelParamsInfo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['ai:modelParamsInfo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script setup name="ModelParamsInfo">
  import { listModelParamsInfo, getModelParamsInfo, delModelParamsInfo, addModelParamsInfo, updateModelParamsInfo } from "@/api/ai/modelParamsInfo";
  ...
  const data = reactive({
    ...
    columns: [
              { key: 0, label: '模型编号', visible: true },
                ...
                { key: 6, label: '安全密钥', visible: true },
                { key: 7, label: '安全KEY', visible: true },
                { key: 8, label: '价格', visible: true },
                { key: 9, label: '模型参数', visible: true },
                { key: 10, label: '模型介绍', visible: true },
                { key: 11, label: '使用次数', visible: true },
                { key: 12, label: '积分', visible: true },
                { key: 13, label: '扩展配置', visible: true },
                { key: 14, label: '状态', visible: true },
                { key: 15, label: '排序', visible: true },
