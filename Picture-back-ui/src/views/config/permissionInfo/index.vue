  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="显示顺序" align="center" prop="orderNum" v-if="columns[3].visible"
                       :show-overflow-tooltip="true"/>
      <el-table-column label="权限标识" align="center" prop="permission" v-if="columns[4].visible"
                       :show-overflow-tooltip="true"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['config:permissionInfo:edit']">修改
          </el-button>
          <el-button link type="primary" icon="Plus" @click="handleAdd(scope.row)"
                     v-hasPermi="['config:permissionInfo:add']">新增
          </el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['config:permissionInfo:remove']">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
} from "@/api/config/permissionInfo";
